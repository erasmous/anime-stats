        ...
        {error ? (
          ...
          <div className="summary">
            <div className="image-wrapper">
              {anime ? <img src={anime.imageURL} alt="images" /> : ""}
            </div>
            <div className="description">
              ...
              <p>{anime?.synopsis}</p>
              <p className="info">
                <span className="label">Release:</span> {anime?.year}
              </p>
              <p className="info">
                <span className="label">Status:</span> {anime?.status}
              </p>
              <p className="info">
                <span className="label">Season:</span> {anime?.season}
              </p>
              <p className="info">
                <span className="label">Other Title:</span> {anime?.otherTitle}
              </p>
              <ul className="genres">
